...
public class MecanumDriveAngleCorrect extends RobotDrive {
     ...
     */
    public MecanumDriveAngleCorrect(Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
     ...
     * @param backRight  the back right motor
     */
    public MecanumDriveAngleCorrect(boolean autoInvert, Motor frontLeft, Motor frontRight, Motor backLeft, Motor backRight) {
    ...
    public void driveFieldCentric(double strafeSpeed, double forwardSpeed,
        ...
        if (turnSpeed != 0.0) targetAngle += clipRange(turnSpeed);
        else targetAngle = gyroAngle;
        ...
        wheelSpeeds[MotorType.kFrontLeft.value] += targetAngle - gyroAngle;
        wheelSpeeds[MotorType.kFrontRight.value] -= targetAngle - gyroAngle;
        wheelSpeeds[MotorType.kBackLeft.value] += targetAngle - gyroAngle;
        wheelSpeeds[MotorType.kBackRight.value] -= targetAngle - gyroAngle;
